...
public class Constantes {
    ...
    public enum InfoPlanetes {
        ...
        InfoPlanetes(double distSoleil, double radius, double periapsis, double apoapsis, String name, double inclination, String texture, double mu, double masse, String tempsOrbite) {
